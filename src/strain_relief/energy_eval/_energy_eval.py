...
from strain_relief.energy_eval import MMFF94_energy, eSEN_energy
...
def predict_energy(
    mols: dict[str : Chem.Mol], method: Literal["eSEN", "MMFF94", "MMFF94s"], **kwargs
):
    ...
    method : Literal["eSEN", "MMFF94", "MMFF94s"]
