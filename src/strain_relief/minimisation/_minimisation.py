...
from strain_relief.minimisation import MMFF94_min, eSEN_min

METHODS_DICT = {"eSEN": eSEN_min, "MMFF94": MMFF94_min, "MMFF94s": MMFF94_min}


def minimise_conformers(
    mols: dict[str : Chem.Mol], method: Literal["eSEN", "MMFF94s", "MMFF94"], **kwargs
) -> dict[str : Chem.Mol]:
    ...
    method : Literal["eSEN", "MMFF94s", "MMFF94"]
